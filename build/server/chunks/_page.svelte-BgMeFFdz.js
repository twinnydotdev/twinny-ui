import { c as pop, p as push } from './index3-DtxWIhGN.js';
...
function _page($$payload, $$props) {
  ...
  `);
  $$payload.out += `<div class="max-w-3xl mx-auto px-6 py-8 rounded-lg shadow-md"><div class="prose prose-slate max-w-none text-white">${html(markdown)}</div></div>`;
  pop();
}

export { _page as default };
//# sourceMappingURL=_page.svelte-BgMeFFdz.js.map
